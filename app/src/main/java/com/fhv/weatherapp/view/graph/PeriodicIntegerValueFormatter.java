...
public class PeriodicIntegerValueFormatter implements IValueFormatter {
    private DecimalFormat decimalFormat = new DecimalFormat("## °C");
    private List<Integer> indexesToShow;

    public PeriodicIntegerValueFormatter(BarDataSet dataSet) {
        super();
